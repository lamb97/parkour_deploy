...
#include "unitree_legged_sdk_3_8_0/loop.h"
#endif
...
class UnitreeHW : public LeggedHW {
 ...
 private:
  ...
  UNITREE_LEGGED_SDK::LowState lowState_ = {0};
  UNITREE_LEGGED_SDK::LowCmd lowCmd_ = {0};
  std::shared_ptr<UNITREE_LEGGED_SDK::LoopFunc> loop_udp_send_ptr_;
  std::shared_ptr<UNITREE_LEGGED_SDK::LoopFunc> loop_udp_recv_ptr_;
  ...
  float loop_frequency_{}; // control freq
